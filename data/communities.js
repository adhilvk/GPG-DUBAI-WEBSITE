export const COMMUNITIES = [
  {
    ...
    paragraphs: [
      ...
      "Community infrastructure includes interconnected swimming pools, children's parks, barbecue stations, outdoor sports courts, and dedicated pet parks. With direct access to The Springs Souk—which features supermarkets, cafes, and retail outlets—The Springs provides strong rental liquidity and high end-user demand.",
    ],
  },
  {
    id: "emirates-hills",
    ...
    paragraphs: [
      ...
      "Residents enjoy 24/7 security, private gated access, and proximity to the Montgomerie Golf Course and Clubhouse. Situated close to major economic hubs while offering private, quiet living, Emirates Hills remains the benchmark for legacy real estate assets in the Middle East.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "Key highlights include an 18-hole championship golf course, the massive Dubai Hills Mall, Kings' College Hospital, top-tier international schools, and the 180,000-square-meter Dubai Hills Park. Its combination of civic infrastructure, central location, and master planning ensures exceptional long-term capital appreciation and rental yield.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "The heart of the community is the central Country Club, featuring fine dining restaurants, swimming pools, padel tennis courts, a state-of-the-art gym, and the European Tour Performance Institute (ETPI). Combining sports, security, and luxury, Jumeirah Golf Estates consistently attracts golf enthusiasts, global executives, and premium investors.",
    ],
  },
  {
    id: "the-meadows",
    ...
    paragraphs: [
      ...
      "Residents benefit from shared amenities including community swimming pools, children's play areas, tennis and basketball courts, dedicated dog parks, and scenic lakeside walking paths. Supported by nearby shopping centers like The Meadows Village and reputable schools, The Meadows remains a highly desirable address for long-term lease investments and family residence.",
    ],
  },
  {
    id: "arabian-ranches",
    ...
    paragraphs: [
      ...
      "The neighborhood is built around a comprehensive array of lifestyle amenities, including the Arabian Ranches Golf Club, the Dubai Polo & Equestrian Club, community retail plazas, and reputable international schools. Its established reputation, strong community spirit, and proven rental yields make Arabian Ranches a benchmark for family residential investments in Dubai.",
    ],
  },
  {
    id: "damac-hills",
    ...
    paragraphs: [
      ...
      "At the center of the development lies the 18-hole Trump International Golf Club Dubai, complemented by the Malibu Bay wave pool, ice skating rinks, horse stables, fishing lakes, and extensive sports courts. With top-rated international schools, healthcare facilities, and retail centers within its gates, DAMAC Hills represents a complete lifestyle hub for families and real estate investors.",
    ],
  },
  {
    id: "al-barari",
    ...
    paragraphs: [
      ...
      "Community lifestyle is centered around holistic living, featuring The Farm—a renowned farm-to-table organic restaurant—the Heart & Soul Spa, and the Body Language health club. With themed gardens, open-air cinema spaces, and dedicated wellness facilities, Al Barari offers an unmatchable residential proposition for environmentally conscious luxury buyers.",
    ],
  },
  {
    id: "district-one",
    ...
    paragraphs: [
      ...
      "At the heart of the development is the world's largest man-made Crystal Lagoon, stretching over seven kilometers and offering swimming, kayaking, and private beach access. The development is encircled by 14 kilometers of dedicated cycling and running tracks, expansive green parklands, and proximity to Meydan Racecourse, making it a premier choice for high-net-worth investors and end-users.",
    ],
  },
  {
    id: "jumeirah-islands",
    ...
    paragraphs: [
      ...
      "Residents enjoy access to the Jumeirah Islands Clubhouse, which features infinity pools, fine dining establishments, casual cafes, a modern fitness center, and sports courts. The community is intertwined with scenic walking and cycling paths along the waterfront, delivering a serene residential experience with strong capital appreciation and high rental demand among affluent expatriates.",
    ],
  },
];
